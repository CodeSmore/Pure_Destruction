...
public class GroundController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Texture2D tex = (Texture2D)Resources.Load("red-planet");
    ...
    public void DestroyGround(float radius, float xPos, float yPos)
    {
        V2int c = World2Pixel(xPos, yPos);
        // c => centro do circulo de destruiçao em pixels
        int r = Mathf.CeilToInt(radius * widthPixel / widthWorld);
